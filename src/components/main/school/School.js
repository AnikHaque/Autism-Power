...
import './School.css'
const School = (props) => {
    const {name,address,img,student,website,phone}=props.school
    return (
        <div>
<div class="card-group">
  <div class="card mt-3 border border-info">
    ...
    <button type="button" class="btn btn-info mx-4"><b className="text-dark mx-5 me-5">Add School</b></button>
    </div>
  </div>
